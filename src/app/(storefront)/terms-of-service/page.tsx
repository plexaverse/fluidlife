...
export default function TermsOfService() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl ">
      <header className="mb-12 ">
        <h1 className="gradient-text text-3xl md:text-4xl text-foreground mb-4 border-b">Terms of Service</h1>
      ...
      <article className="prose prose-lg max-w-none">
        <p>
          This website is operated by Fluidlife, operated by Fluidlife Health and Hygiene. 
          Throughout the site, the terms &quot;we&quot;, &quot;us&quot;, and &quot;our&quot; refer to Fluidlife. 
          Fluidlife offers this website, including all information, tools, and services 
        ...
        <h2 className='text-2xl mb-2 mt-8'>SECTION 1 - GENERAL</h2>
        <p>
        ...
        <h2 className="text-2xl mb-2 mt-8">SECTION 2 - GENERAL CONDITIONS</h2>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
  <p>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 5 - PRODUCTS OR SERVICES</h2>
  <p>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
  <p>
    ...
    We reserve the right to limit or prohibit orders that, in our sole judgement, appear to be 
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 7 - OPTIONAL TOOLS</h2>
  <p>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 8 - THIRD-PARTY LINKS</h2>
  <p>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 9 - USER COMMENTS, FEEDBACK, AND OTHER SUBMISSIONS</h2>
  <p>
    ...
    materials, whether online, by email, by postal mail, or otherwise (&apos;comments&apos;), 
  ...
  <p>
    ...
    our sole discretion are unlawful, offensive, threatening, libellous, defamatory, pornographic, 
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 10 - PERSONAL INFORMATION</h2>
  <p>Your submission of personal information through the store is governed by our Privacy Policy.</p>

  <h2 className="text-2xl mb-2 mt-8">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
  <p>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 12 - PROHIBITED USES</h2>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
  <p>
  ...
  <p>
    In no case shall Fluidlife, our directors, officers, employees, affiliates, agents, contractors, 
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 14 - INDEMNIFICATION</h2>
  <p>
    You agree to indemnify, defend and hold harmless Fluidlife and our parent, subsidiaries, 
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 15 - SEVERABILITY</h2>
  <p>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 16 - TERMINATION</h2>
  <p>
  ...
  <h2 className="text-2xl mb-2 mt-8">SECTION 17 - ENTIRE AGREEMENT</h2>
  <p>
  ...
  <p>
    ...
    against the drafting party.
        ...
        <h2 className='text-2xl mb-2 mt-8'>SECTION 18 - GOVERNING LAW</h2>
        <p>
        ...
        <h2 className="text-2xl mb-2 mt-8">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
<p>
...
<p>
  ...
  acceptance of those changes.
        ...
        <h2 className='text-2xl mb-2 mt-8'>SECTION 20 - CONTACT INFORMATION</h2>
        <p>
