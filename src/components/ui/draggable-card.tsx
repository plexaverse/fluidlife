...
/**
 * Aceternity draggable 3D card. Ported from takekare; uses framer-motion
 * (Fluidlife already depends on it) instead of takekare's `motion/react` alias.
 */
export function DraggableCardBody({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative min-h-40 w-40 overflow-hidden rounded-md bg-neutral-100 p-2 shadow-2xl transform-3d dark:bg-neutral-900",
        className,
      )}
    >
      {children}
